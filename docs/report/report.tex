...
interface as seen in \ref{fig:midi-selection}. This interface consisted of a
single MIDI upload button and any number of MIDI file items.
...
In the top pane, we render the notes over time graph as seen in the
